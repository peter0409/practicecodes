 ...
 * 
 * import com.nivtek.quoteinfo.entity.Role; import
 * com.nivtek.quoteinfo.entity.User;
 * 
 * @Component public class BootstrapUser implements
 ...
 * }
 * 
 * private void createUserWithRole(String username, String password, String
 * email, Role authority) { User user = new User(username, new
 * BCryptPasswordEncoder().encode(password), username, username, email,
 * authority, true); userRepository.save(user);
 * 
 * }
 * 
 * }
